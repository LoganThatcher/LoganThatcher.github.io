...
The game begins establishing the quest and giving a short backstory.

![Image of Over World Start](https://loganthatcher.com/images/LoK/images/OverWorldStart.png)

There is an overworld (similar to Mario games) where players can choose which level to play and 
...
Boss doors are denoted by being purple and having purple particles rising out of them.
...
Monsters now have one more health, there tends to be more monsters in a room, and 
there tends to be more projectiles filling the room.
...
This boss generates lots of projectiles and lava pools creating more dangerous environment requiring the player 
to be more aware of their movement and the threats in the room.
